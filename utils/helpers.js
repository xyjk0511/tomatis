...
export function SafeIcon({ Icon, fallback = '•', ...props }) {
  if (Icon === undefined || Icon === null) {
      ...
      return React.createElement('span', { style: { opacity: 0.6, fontSize: props.size || 16 } }, fallback);
  }
...
export class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return React.createElement('div', { style: { padding: 12, color: '#fca5a5', fontFamily: 'monospace', backgroundColor: '#330000', border: '1px solid #ff0000' } },
